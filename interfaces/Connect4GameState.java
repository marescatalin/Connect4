...
/**
 * 
 * A class that represents the current state of a Connect4 game, including the
 * configuration of the board and whose turn it is. The class is abstract and is
 * to be extended by your own implementation of all the methods.
 */
...
public abstract class Connect4GameState {
    ...
    /**
     * The number of counters of a given colour should be in a row to win the
     * game
     */
